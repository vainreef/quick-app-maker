...
This directory contains the x64 MSIX asset used by the Vainreef bootstrap flow.
...
Bootstrap uses this repository copy directly. The bootstrap path has no external WinAppCLI download.
